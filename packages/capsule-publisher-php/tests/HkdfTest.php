...
{
    /** RFC 5869 §A.1 — Test Case 1: HKDF-SHA-256 with non-empty salt + info. */
    public function testRfc5869TestCase1(): void
    {
        ...
        $expectedOkm = '3cb25f25faacd57a90434f64d0362f2a' .
                       '2d2d0a90cf1a5a4c5db02d56ecc4c5bf' .
                       '34007208d5b887185865';
        $okm = Hkdf::sha256($ikm, $salt, $info, 42);
        self::assertSame($expectedOkm, bin2hex($okm));
    }

    /** RFC 5869 §A.2 — Test Case 2: long inputs. */
    public function testRfc5869TestCase2(): void
    {
        ...
        $expectedOkm = 'b11e398dc80327a1c8e7f78c596a4934' .
                       '4f012eda2d4efad8a050cc4c19afa97c' .
                       '59045a99cac7827271cb41c65e590e09' .
                       'da3275600c2f09b8367793a9aca3db71' .
                       'cc30c58179ec3e87c14c01d5c1f3434f' .
                       '1d87';
        $okm = Hkdf::sha256($ikm, $salt, $info, 82);
        self::assertSame($expectedOkm, bin2hex($okm));
    }
}
